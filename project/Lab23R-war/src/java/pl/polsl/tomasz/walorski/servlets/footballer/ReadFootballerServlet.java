 ...
 * @version 1.1
 */
@WebServlet(name = "ReadFootballerServlet", urlPatterns = {"/ReadFootballerServlet"})
public class ReadFootballerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            List<Footballer> footballers = footballerBean.readAll();          
            for(Footballer footballer: footballers)
                out.print(footballer.toString() + "<br>");
            storeApplicationHistory("CityRead",request,response);
        }
    }
