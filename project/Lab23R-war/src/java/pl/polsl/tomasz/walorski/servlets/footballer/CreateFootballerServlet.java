...
/**
 * Servlet for creating footballers.
 * @author Tomasz Walorski 
 * @version 1.1
 */
@WebServlet(name = "CreateFootballerServlet", urlPatterns = {"/CreateFootballerServlet"})
public class CreateFootballerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList <String> errors = controller.isInputCorrectForCreate(fullName, clubNumber, birthDate, playingPosition, clubId);
            ...
            if(errors.isEmpty()){
                ...
                out.println("Footballer was created and added to the database");
                storeApplicationHistory("additionFootballer",request,response);
            }else{
