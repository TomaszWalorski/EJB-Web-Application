...
/**
 * Servlet for reading clubs.
 * @author Tomasz Walorski
 * @version 1.1
 */
@WebServlet(name = "ReadClubServlet", urlPatterns = {"/ReadClubServlet"})
public class ReadClubServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            List<Club> clubs = clubBean.readAll();          
            for(Club club: clubs)
                out.print(club.toString() + "<br>");
