...
/**
 * Servlet for updating clubs.
 * @author Tomasz Walorski
 * @version 1.1
 */
@WebServlet(name = "UpdateClubServlet", urlPatterns = {"/UpdateClubServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            final String clubId = request.getParameter("clubId"),
                clubFullName = request.getParameter("clubFullName"),
            ...
            if(controller.isInteger(clubId)!=null){
                ...
                if(clubBean.read(id) == null){
                    ...
                    errors = controller.isInputCorrectForUpdate(clubId, clubFullName, clubShortName, founded, city);
                }
            }
            if(errors.isEmpty()){
                clubBean.update(club);                   
                out.println("Club was updated corretly.");
                storeApplicationHistory("updateClub",request,response);
            }else{
